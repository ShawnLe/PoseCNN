...
CV_INC=/usr/local/opencv-3.4.1_gcc4.8_noContrib_noCUDAW/include
CV_LIB=/usr/local/opencv-3.4.1_gcc4.8_noContrib_noCUDAW/lib
echo $TF_INC
...
g++ -std=c++11 -shared -o hough_voting_gpu.so hough_voting_gpu_op.cc \
	hough_voting_gpu_op.cu.o -I $TF_INC -I$TF_INC/external/nsync/public -fPIC -lcudart -lcublas -lopencv_imgproc -lopencv_calib3d -lopencv_core -L $CUDA_PATH/lib64 -L$TF_LIB -ltensorflow_framework -I $CV_INC -L$CV_LIB
...
g++ -std=c++11 -c -o Hypothesis.o Hypothesis.cpp -fPIC -I$CV_INC
...
g++ -std=c++11 -shared -o hough_voting.so hough_voting_op.cc \
	Hypothesis.o thread_rand.o -I $TF_INC -I$TF_INC/external/nsync/public \
        -fPIC -lcudart -lopencv_imgproc -lopencv_calib3d -lopencv_core -lgomp -lnlopt -L $CUDA_PATH/lib64 -L$TF_LIB -ltensorflow_framework -I $CV_INC -L$CV_LIB
